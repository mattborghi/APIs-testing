...
class CreateLink(graphene.Mutation):
    ...
    #3: The mutation method: it creates a link in the database 
    # using the data sent by the user, through the url and description parameters. 
...
#4: reates a mutation class with a field to be resolved, 
